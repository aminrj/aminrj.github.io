---
title: LLM-Engineering; Building a Procurements Analyst AI
date: 2026-01-26
uuid: 202512180000
status: published
...
That ge=0, le=1 is not decoration. It’s the difference between “confidence = 0.92” and “confidence = 9.2” breaking your system silently.
...
return f"""{prompt}
You must respond with ACTUAL DATA in JSON format, not a schema.Here's the expected format with CORRECT value types:
{example_json}
...
This is “agent orchestration,” but it’s intentionally simple. You can understand every branch without mental overhead.
